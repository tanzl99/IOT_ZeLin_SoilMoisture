...
#define WIFI_SSID "YOUR_WIFI" //YOUR WIFI NAME HERE
#define WIFI_PASSWORD "YOUR_WIFI_PASSWORD" //YOUR WIFI PASSWORD HERE
/* 2. Define the API Key */
#define API_KEY "YOUR_API_KEY" //YOUR API KEY HERE
#define DATABASE_URL "YOUR_DATABASE_URL" //YOUR DATABASE URL HERE 
...
#define USER_EMAIL "YOUR_EMAIL" //YOUR EMAIL HERE
#define USER_PASSWORD "YOUR_EMAIL_PASSWORD" //YOUR EMAIL PASSWORD HERE
FirebaseData fbdo;
FirebaseAuth auth;
